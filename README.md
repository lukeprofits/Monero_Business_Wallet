...
## How It Works: 
* Launch the wallet.
* Select if you would like to have Monero recieved auto-forwarded to cold storage, or converted to a stable coin and auto-forwarded to an exchange (where it can be sold for USD).
