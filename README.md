...
* Leave the wallet open and running. Incoming payments will automatically be recorded in a local spreadsheet (for taxes & autotomatically marking orders as "paid" with future software), and will then be forwarded based on your preferences.
